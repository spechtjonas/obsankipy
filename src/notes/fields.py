...
class ContextField: 
    ...
    def __init__(self, relative_path, hierarchy, field_name):

        self.field_name = field_name
        
        hierarchy_chain = " > ".join(hierarchy)
        self.text = f"{relative_path} > {hierarchy_chain}"
...
class LinkField:
    ...
    def __init__(self, file_name, vault_name, field_name):

        self.field_name = field_name
        
        self.text = create_link(
            vault_name=vault_name,
            file_name=file_name,
            name_alias="Obsidian",
        )
